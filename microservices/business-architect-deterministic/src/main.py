...
from .business_architect import BusinessArchitectAgent, AnalysisResult
...
app = FastAPI(
    ...
    description="Microservice for business architect using deterministic",
    version="1.0.0",
    lifespan=lifespan
)
...
async def health_check():
    ...
    return {"status": "healthy", "service": "business-architect-deterministic"}
