...
async def health_check():
    ...
    return HealthResponse(status="healthy", service="simple-web")

@app.get("/ready", response_model=HealthResponse)
async def readiness_check():
    """Readiness check endpoint for Kubernetes probes"""
    return HealthResponse(status="ready", service="simple-web")

@app.get("/")
async def root():
    """Root endpoint"""
    return {"message": "Hello from simple-web", "architecture": "onion"}
