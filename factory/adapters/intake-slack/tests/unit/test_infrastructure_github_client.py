...
class TestGitHubApiClient:
    ...
    def setup_method(self):
        ...
        self.client = GitHubApiClient(
            token="test_token", repository="test_owner/test_repo", timeout=10
        )
    ...
    def test_validate_configuration_missing_token(self):
        ...
        client = GitHubApiClient(token="", repository="test_owner/test_repo")
    ...
    def test_validate_configuration_invalid_repository(self):
        ...
        client = GitHubApiClient(token="test_token", repository="invalid_repo")
    ...
    def test_logging_during_error(self, mock_post, mock_logger):
        ...
        error_call = [
            call for call in mock_logger.error.call_args_list if "❌" in str(call)
        ]
