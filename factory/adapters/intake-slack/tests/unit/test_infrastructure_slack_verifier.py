...
class TestSlackSignatureVerifier:
    ...
    def test_verify_request_success(self):
        ...
        expected_signature = (
            "v0="
            + hmac.new(
                b"test_signing_secret", sig_basestring, hashlib.sha256
            ).hexdigest()
        )

        result = self.verifier.verify_request(
            request_data, timestamp, expected_signature
        )
    ...
    def test_verify_request_invalid_signature(self):
        ...
        result = self.verifier.verify_request(
            request_data, timestamp, invalid_signature
        )
    ...
    def test_verify_request_invalid_timestamp(self):
        ...
        result = self.verifier.verify_request(
            request_data, invalid_timestamp, signature
        )
    ...
    def test_constant_time_comparison(self):
        ...
        result1 = self.verifier.verify_request(
            request_data, timestamp, correct_signature
        )
