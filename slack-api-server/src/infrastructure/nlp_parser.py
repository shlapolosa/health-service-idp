...
from ..domain.models import SlackCommand, ParsedCommand, VClusterSize, Capability, ParsingError
...
class EnhancedNLPParser(CommandParserInterface):
    ...
    CAPABILITY_KEYWORDS = {
        Capability.OBSERVABILITY: ['observability', 'monitoring', 'metrics', 'grafana', 'prometheus'],
