...
class GitHubApiClient(GitHubDispatcherInterface):
    ...
    def trigger_vcluster_creation(self, payload: Dict) -> Tuple[bool, str]:
        ...
        try:
            logger.info(f"Triggering GitHub repository dispatch for VCluster: {payload.get('client_payload', {}).get('vcluster_name', 'unknown')}")
    ...
    def validate_configuration(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return False, f"Repository {self.repository} not found or not accessible"
            else:
