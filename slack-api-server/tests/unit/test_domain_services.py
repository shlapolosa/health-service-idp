...
from src.domain.services import (
    VClusterFactoryService, VClusterValidationService, SlackResponseBuilderService
)
...
class TestVClusterValidationService:
    ...
    def test_invalid_name(self):
        ...
        assert len(errors) == 1
        assert "Invalid VCluster name" in errors[0]
    ...
    def test_invalid_namespace(self):
        ...
        assert is_valid is False
        assert len(errors) == 1
        assert "Invalid namespace" in errors[0]
