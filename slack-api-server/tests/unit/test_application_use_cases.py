...
class TestCreateVClusterUseCase:
    ...
    def test_execute_create_success(self):
        ...
        self.mock_github_dispatcher.trigger_vcluster_creation.return_value = (True, "Success")
        self.mock_response_builder.build_success_response.return_value = success_response
        ...
        self.mock_response_builder.build_success_response.assert_called_once_with(request)
    ...
    def test_execute_create_github_failure(self):
        ...
        self.mock_factory.create_vcluster_request.return_value = request
        self.mock_validator.validate_request.return_value = (True, [])
        self.mock_github_dispatcher.trigger_vcluster_creation.return_value = (False, "API Error")
        self.mock_response_builder.build_error_response.return_value = error_response
...
class TestProcessSlackCommandUseCase:
    ...
    def test_execute_future_commands(self):
        ...
        for cmd_text in commands:
            ...
            assert result == error_response
            assert "coming soon" in self.mock_response_builder.build_error_response.call_args[0][0].lower()
